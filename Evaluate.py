...
if __name__ == '__main__':
    problem_file = "data/output/deepseek-coder-v2/n=164/passAt1.0/human-eval-v2-full.jsonl"
    sample_file = "data/output/deepseek-coder-v2/n=164/passAt1.0/human-eval-v2-full_output.jsonl"
